...
if __name__ == "__main__":
    ...
    parser.add_argument('--device-id', default='ED-001', help='Device ID to report to server')
    parser.add_argument('--source', default='yolo/test/Clayton South fatal car crash caught on CCTV.mp4', help='Video source: 0 (default webcam) or path to video file')

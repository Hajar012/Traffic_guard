...
if __name__ == "__main__":
    ...
    parser.add_argument('--device-id', default='ED-002', help='Device ID to report to server')
    parser.add_argument('--source', default='yolo/test/3 injured in Savage car crash.mp4', help='Video source: 0 (default webcam) or path to video file')
